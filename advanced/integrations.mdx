...
<CardGroup cols={3}>
  <Card title="Retell AI" icon="robot">
    - **Voice Agent Integration**: Deep integration with Retell's voice AI platform
    - **Real-time Sync**: Automatic agent synchronization
  ...
  <Card title="OpenAI & ElevenLabs" icon="microphone">
